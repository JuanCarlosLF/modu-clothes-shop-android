...
import com.example.modu.catalog.generator.validation.CatalogSeedValidator
    ...
    companion object {
        fun fromProjectRoot(projectRoot: Path): CatalogGenerationPaths = CatalogGenerationPaths(
            schema = projectRoot.resolve(
                "app/schemas/com.example.modu.data.dataSource.local.demo.database.ModuDemoDatabase/1.json"
            ),

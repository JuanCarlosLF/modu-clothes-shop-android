...
import com.juancarloslf.modu.catalog.generator.exception.CatalogSchemaParseException
...
internal class RoomSchemaParserTest {
    ...
    private fun roomSchemaPath(): Path {
        val relativePath = Path.of(
            "app",
            "schemas",
            "com.juancarloslf.modu.data.dataSource.local.demo.database.ModuDemoDatabase",
            "1.json"
        )

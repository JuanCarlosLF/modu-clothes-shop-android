...
import com.juancarloslf.modu.catalog.generator.exception.CatalogSeedValidationException
...
internal class CatalogDatabaseGeneratorTest {
    ...
    fun fromProjectRoot_whenCalled_thenResolvesExactFixedPaths() {
        ...
        assertEquals(
            CatalogGenerationPaths(
                schema = root.resolve("app/schemas/com.juancarloslf.modu.data.dataSource.local.demo.database.ModuDemoDatabase/1.json"),
    ...
    private fun roomSchemaPath(): Path {
        val relative = Path.of(
            "app", "schemas",
            "com.juancarloslf.modu.data.dataSource.local.demo.database.ModuDemoDatabase", "1.json"
        )

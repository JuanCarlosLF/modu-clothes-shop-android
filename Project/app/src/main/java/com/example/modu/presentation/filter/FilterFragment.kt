    ...
    private fun setupListeners() {
        binding?.let { safeBinding ->
            with(safeBinding) {
                ...
                headerFilterTitle.setupAccordion(iconArrowTitle, contentFilterTitle)
                headerFilterPrice.setupAccordion(iconArrowPrice, contentFilterPrice)
                headerFilterRange.setupAccordion(iconArrowRange, contentFilterRange)
                headerFilterCategory.setupAccordion(iconArrowCategory, rvFilterCategory)
